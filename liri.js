...
function showTweets(){
  ...
  var screenName = {screen_name: 'm123gin'};
  client.get('statuses/user_timeline', screenName, function(error, tweets, response){
    if(!error){
      for(var i = 0; i<tweets.length; i++){
        var date = tweets[i].created_at;
        console.log("@M123Gin: " + tweets[i].text + " Created At: " + date.substring(0, 19));
        console.log("-----------------------");
        
        //adds text to log.txt file
        fs.appendFile('log.txt', "@M123Gin: " + tweets[i].text + " Created At: " + date.substring(0, 19));
